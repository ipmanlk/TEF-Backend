...
export class GeneralController {
    static async get(data) {
        ...
        const generalTables = ["gender", "civil_status", "module", "user_status", "customer_status", "customer_type", "material_status", "material_type", "unit_type", "risk_category", "product_status", "category", "product_type", "product_package_status", "product_package_type"];
